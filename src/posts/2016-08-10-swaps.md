...
You expect income in the next couple years, but that income will be denoted in Japanese Yen.
What will happen to the revenue that gets remitted to HQ if the Japanese Yen decreases in value
...
For example, if you are going to receive 1,000,000 Yen every year for the next 5 years, and
you are planning on converting Yen to CAD at the end of each year, then clearly your revenue
will be exposed to changes in exchange rates from now until the end of the fifth year.
If the rate right now is 100 Yen/CAD, and it never changes, then at the end of each year
you can expect to receive 10,000 CAD (1,000,000 / 100). But if the value of the Yen goes down and the exchange
rate becomes 120 Yen/CAD (and stays that way until the last year), you'll end up with only
8,333.33 CAD (1,000,000 / 120) per year.

Of course, like in the previous case, there's the possibility of upside, where if the Japanese
Yen appreciates against the CAD (i.e. increases in value against the CAD) you'll end up receiving
